...
class CartViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
    ...
    public CartViewHolder(View itemView) {
        ...
        txt_precio=(TextView)itemView.findViewById(R.id.cart_item_precio);
...
public class CartAdapter extends  RecyclerView.Adapter<CartViewHolder> {
    ...
    public CartAdapter(List<Pedido> listData, Context context) {
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        NumberFormat fmt=NumberFormat.getCurrencyInstance(locale);
            ...
            try {
                int precio=0;
                precio =Integer.parseInt((listData.get(position).getPrecio()))*Integer.parseInt((listData.get(position).getCantidad()));
